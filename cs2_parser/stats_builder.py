...
# Make stats_builder available as a module-like object
class StatsBuilderModule:
    """Wrapper to make stats_builder compatible with main.py expectations"""
    
    @staticmethod
    def compute_stats(events):
        """Wrapper for the existing compute_stats function"""
        return compute_stats(events)
    
    @staticmethod
    def default_player_stat_entry():
        """Wrapper for existing function"""
        return default_player_stat_entry()

# Create module instance for import compatibility
stats_builder = StatsBuilderModule()
